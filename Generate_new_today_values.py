...
for i in range(20000):
    ...
    start_time = datetime.datetime(today.year, today.month, today.day-9, 8)
    end_time = datetime.datetime(today.year, today.month, today.day-9, 17)
    ...
    random_value = random.randint(30, 110)
